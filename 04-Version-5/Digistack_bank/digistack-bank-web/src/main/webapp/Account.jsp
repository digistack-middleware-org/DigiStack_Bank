...
<body>
        ...
        <nav class="navbar db-navbar shadow-sm" style="background:linear-gradient(90deg,#0b2545,#13315c);padding:0.75rem 0;">
            <div class="container">
                <a class="navbar-brand fw-bold" style="color:#fff;font-size:1.2rem;"
                href="${pageContext.request.contextPath}/home">
                    DigiStack <span style="color:#c9a227;">Bank</span>
                </a>
                <div class="d-flex align-items-center gap-3">
                    ...
                    style="color:rgba(255,255,255,0.7);border:1px solid rgba(255,255,255,0.3);font-size:0.8rem;padding:0.25rem 0.75rem;border-radius:20px;text-decoration:none;">
                        Logout
                    </a>
                </div>
            </div>
