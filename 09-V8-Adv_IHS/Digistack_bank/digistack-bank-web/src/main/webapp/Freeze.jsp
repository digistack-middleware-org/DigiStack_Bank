            ...
            <div class="col-lg-7">
                ...
                <div class="alert-success-custom">
                    ...
                    <div>
                        ...
                        <a href="Unfreeze" class="alert-action-link">
                            Unfreeze
                        </a>
                        to restore access.
                    </div>
                ...
                <div class="alert-error-custom">
                    <i class="bi bi-exclamation-circle-fill
                              alert-icon"></i>
                    <div>
                        <strong>Freeze Failed</strong><br>
                        <%= error %>
                    </div>
                </div>
                <% } %>
                ...
                <%-- ── Already Frozen — show notice only ── --%>
                <% if (frozen) { %>
                ...
                <%-- ── Not Frozen — show confirmation form ── --%>
                <% } else { %>
                <div class="confirm-card confirm-card-freeze">
                    ...
                    <p class="confirm-description">
                        ...
                        <strong>immediately block</strong>
                        all deposits and withdrawals. You can
                        unfreeze at any time from the
                        <a href="Unfreeze" class="confirm-page-link">
                            Unfreeze page
                        </a>.
                    </p>
